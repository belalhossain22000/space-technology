    ...
    return (
        <section className='mt-[100px] text-white px-[30px] lg:px-[40px] xl:px-[60px]  2xl:px-[134px]'>
            ...
            <div className='flex flex-wrap items-center justify-center gap-[23px]'>
                {
                    planetData.map(({ title, name, image, id }) => <div key={id} className='flex flex-col justify-center relative bg-re-500 text-center w-[352px] h-[287px] rounded-[19px] my-[50px] xl:my-0' style={{ background: "linear-gradient(180deg, rgba(38, 1, 83, 0.00) 14.62%, #250153 100%)" }} >
