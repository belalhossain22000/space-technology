...
const Destination = () => {
    return (
        <section className='relative lg:flex items-center justify-center  gap-5 3xl:ml-[10%] md:mt-[60px] xl:mt-[200px] px-[30px] lg:px-[40px] xl:px-[60p]  2xl:px-[134p] ' >
            ...
            <div className='relative lg:w-1/2 text-white text-center lg:text-left '>
                <h1 className='xl:text-[100px] md:text-[70px] sm:text-[50px] text-[40px] font-normal leading-[100px] text-white'>Destinations <br />you can visit <br /> <span className='text-[#FF2C01]'>without a visa</span></h1>
...
//     WebkitBackgroundBlendMode: 'color-dodge',
//     mixBlendMode: 'color-dodge',
// }}
// bg-[url("/ultimate-bg.png")] bg-cover bg-no-repeat bg-center