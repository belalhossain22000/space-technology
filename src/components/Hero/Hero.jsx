        ...
        <section className='bg-[url("/heroimage.png")] bg-no-repeat bg-cover bg-center  '>
            <div className='xl:w-[1170px] mx-auto max-w-full px-6 xl:px-0'>
                <div className='lg:pb-[154px] md:pb-[75px] pb-[55px] lg:pt-[236px] pt-[110px] md:pt-[120px]' >
                    <h1 style={{ fontFamily: 'Bebas Neue' }} className=' w-fit text-[#FFF] text-[43px] leading-[43px] md:text-[65px] md:leading-[70px] lg:text-[100px] font-normal lg:leading-[100px] tracking-[(-0.5px)]'>  PUT YOUR FOOTPRINT IN <br /> <span className='' style={{
