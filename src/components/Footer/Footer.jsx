...
const Footer = () => {
    return (
        <footer className='relative w-full px-[30px] lg:px-[40px] xl:px-[60px]  2xl:px-[134px]' style={{ backgroundImage: "linear-gradient(180deg, #4A188C 0%, #3E0174 13.32%, #0C003D 100%)" }}>
            ...
            <div className='md:w-[85%] w-full  bg-[#18004A] md:h-[435px] rounded-[40px] text-center text-white absolute top-[-200px] left-[-4.5%]  p-5 md:p-0 lg:left-[7%]  xl:left-[8%] 2xl:left-[8%] md:left-[7%] xl:py-[103px] lg:py-[70px] lg:px-[100px] md:py-[50px] md:px-[80px] xl:px-[200x] mx-5 md:mx-0' style={{ backgroundImage: "linear-gradient(140deg, #6F26BB 0%, rgba(111, 38, 187, 0.00) 100%, #6F26BB 100%)" }}>
